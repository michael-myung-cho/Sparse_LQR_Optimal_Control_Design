...
import problem_setting, LISTA, train, test
...
T: ???
"""
layers = LISTA.build_LISTA(prob,T=30,initial_gamma=1.0,initial_rho=100,untied=False)
print("Network organization finished")

# plan the learning
training_stages = train.setup_training(layers,prob,trinit=0.0001)
print("Training setup finished")



# do the learning (takes a while)
sess = train.do_training(training_stages,layers,prob,maxit=1000,r=1000)
